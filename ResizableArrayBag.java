...
public final class ResizableArrayBag<T> implements BagInterface<T> {
	...
	public BagInterface<T> union(BagInterface<T> anotherBag) {
		...
		BagInterface<T> fBag = new ResizableArrayBag<T>();
		ResizableArrayBag<T> anbag = (ResizableArrayBag<T>) anotherBag;
		int i = 0;
		...
		i = 0;
		while (i < anbag.numberOfEntries) {
			fBag.add(anbag.bag[i]);
			i++;
		}
		return fBag;
	}
	...
	public BagInterface<T> intersection(BagInterface<T> anotherBag) {
		...
		BagInterface<T> fBag = new ResizableArrayBag<T>();
		ResizableArrayBag<T> anBag = (ResizableArrayBag<T>) anotherBag;
		BagInterface<T> copyBag = new ResizableArrayBag<T>();
		int i = 0;
		while (i < anBag.numberOfEntries) {
			copyBag.add(anBag.bag[i]);
			i++;
		}
		for (i = 0; i < getCurrentSize(); i++) {
			if (copyBag.contains(bag[i])) {
				fBag.add(bag[i]);
				copyBag.remove(bag[i]);
			}
		}
		return fBag;
	}
	...
	public BagInterface<T> difference(BagInterface<T> anotherBag) {
		ResizableArrayBag<T> nBag = new ResizableArrayBag<>((T[]) this.toArray());
		for (int j = 0; j < anotherBag.getCurrentSize(); j++) {
			nBag.remove((T) anotherBag.toArray()[j]);
		}
		return nBag;
	}
	...
	public void removeEvery(T anEntry) {
		// TODO Auto-generated method stub
		ResizableArrayBag<T> bag = new ResizableArrayBag<T>(numberOfEntries);
		@SuppressWarnings("unchecked")
